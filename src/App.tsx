      ...
      <BrowserRouter>
        ...
        <Routes>
          <Route
            path="/"
            element={
              <HomePage loginButtonTextHandler={loginButtonTextHandler} />
            }
          />
          <Route
            path="/login"
            element={
              <LogInPage loginButtonTextHandler={loginButtonTextHandler} />
            }
          />
          <Route
            path="/login/customer/:name"
            element={
              <CustomerPage loginButtonTextHandler={loginButtonTextHandler} />
            }
          />
          <Route
            path="/login/cleaner/:name"
            element={
              <CleanerPage loginButtonTextHandler={loginButtonTextHandler} />
            }
          />
